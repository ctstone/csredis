...
namespace CSRedis.Tests
{
    ...
    public class ServerTests
    {
        ...
        {
            using (var mock = new MockConnector("MockHost", 9999, "$6\r\nmyname\r\n"))
            using (var redis = new RedisClient(mock, new UTF8Encoding(false)))
            {
        ...
        public void ClientKillTest()
        {
            var reply1 = "+OK\r\n";
            var reply2 = ":1\r\n";
            using (var mock = new MockConnector("MockHost", 9999, reply1, reply2, reply2, reply2, reply2, reply2))
            using (var redis = new RedisClient(mock, new UTF8Encoding(false)))
            {
        ...
        public void InfoTest()
        {
            ...
            var reply2 = "$104\r\n# CPU\r\nused_cpu_sys:140.26\r\nused_cpu_user:43.95\r\nused_cpu_sys_children:0.00\r\nused_cpu_user_children:0.00\r\n";
            using (var mock = new MockConnector("MockHost", 9999, reply1, reply2))
            using (var redis = new RedisClient(mock, new UTF8Encoding(false)))
            {
        ...
        {
            using (var mock = new MockConnector("MockHost", 9999, ":1404861064\r\n"))
            using (var redis = new RedisClient(mock, new UTF8Encoding(false)))
            {
        ...
        {
            using (var mock = new MockConnector("MockHost", 9999, true, "+OK\r\n"
        ...
        public void RoleTest()
        {
            ...
            using (var mock = new MockConnector("MockHost", 9999, reply1, reply2, reply3))
            using (var redis = new RedisClient(mock, new UTF8Encoding(false)))
            {
        ...
        {
            using (var mock = new MockConnector("MockHost", 9999, "", "", ""))
            using (var redis = new RedisClient(mock, new UTF8Encoding(false)))
            {
