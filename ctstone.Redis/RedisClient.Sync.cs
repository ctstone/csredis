...
namespace CSRedis
{
    public partial class RedisClient
    {
        ...
        {
            return Write(RedisCommand.ZCount(key, min, max));
        }
        ...
        {
            return Write(RedisCommand.ZRangeWithScores(key, start, stop));
        }
        ...
        {
            return Write(RedisCommand.ZRangeByScore(key, min, max, withScores, offset, count));
        }
        ...
        {
            return Write(RedisCommand.ZRangeByScoreWithScores(key, min, max, exclusiveMin, exclusiveMax, offset, count));
        }
        ...
        {
            return Write(RedisCommand.ZRangeByScoreWithScores(key, min, max, offset, count));
        }
        ...
        {
            return Write(RedisCommand.ZRevRangeWithScores(key, start, stop));
        }
        ...
        {
            return Write(RedisCommand.ZRevRangeByScore(key, max, min, withScores, offset, count));
        }
        ...
        {
            return Write(RedisCommand.ZRevRangeByScoreWithScores(key, max, min, exclusiveMax, exclusiveMin, offset, count));
        }
        ...
        {
            return Write(RedisCommand.ZRevRangeByScoreWithScores(key, max, min, offset, count));
        }
        ...
        {
            return Write(RedisCommand.ZUnionStore(destination, null, null, keys));
        }
